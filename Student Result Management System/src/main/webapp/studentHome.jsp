...
<center><img src="mgi.png" width="150" height="150">
<img src="apj sir.png" align="right"  width="150" height="150"></center>
    <a href="mgiOneView.html">Back</a>
  <hr class="new1">
<style>
table{
  width:100%;
   ...
   <table style="border-collapse: collapse;">
      ...
      <thead>
        <tr>
          ...
          <th><a title="Print Screen" onclick="window.print();" target="_blank" style="cursor:pointer; display: block; text-align: center;">
    <img src="print.png" alt="Print Screen"></a></th>
        </tr>
      </thead>
    </table>
  </div>
...
{
	response.sendRedirect("errorMgiOneView.html");
  }
}
catch(Exception e)
{}%>